...
<html>
    <head>
        ...
        <link type="text/css" href="css/tictactoe.css" rel="stylesheet" />
    ...
    <body id="main">
        ...
        <div id="board">
            ...
            <img id="strokeh" class="stroke" src="images/strokeh.png" width="226px" height="24px">
            <img id="strokev" class="stroke" src="images/strokev.png" width="24px" height="226px">
            <img id="stroked" class="stroke" src="images/stroketb.png" width="226px" height="226px">
        </div>
